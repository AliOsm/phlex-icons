...
module Phlex
  module Icons
    module Remix
      class DashboardHorizontalFill < Base
        def view_template
          svg(
            **attrs,
            viewbox: '0 0 24 24',
