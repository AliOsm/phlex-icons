...
module Phlex
  module Icons
    module Bootstrap
      class EmojiAstonishedFill < Base
        def view_template
          svg(
            **attrs,
