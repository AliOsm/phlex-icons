        ...
        def view_template
          svg(
            **attrs,
            ...
            s.path(
              d:
                'M5 8.5A2.5 2.5 0 0 1 7.5 6H9V4.534a.25.25 0 0 1 .41-.192l2.36 1.966c.12.1.12.284 0 .384L9.41 8.658A.25.25 0 0 1 9 8.466V7H7.5A1.5 1.5 0 0 0 6 8.5V11H5z'
            )
            s.path(
              fill_rule: 'evenodd',
              d:
