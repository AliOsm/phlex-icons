...
module Phlex
  module Icons
    module Bootstrap
      class EnvelopeOpenHeartFill < Base
        def view_template
          svg(
            class: classes,
