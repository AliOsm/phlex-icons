        ...
        def view_template
          svg(
            ...
            s.path(
              fill_rule: 'evenodd',
              d:
                'M8 11a.5.5 0 0 0 .5-.5V6.707l1.146 1.147a.5.5 0 0 0 .708-.708l-2-2a.5.5 0 0 0-.708 0l-2 2a.5.5 0 1 0 .708.708L7.5 6.707V10.5a.5.5 0 0 0 .5.5'
            )
            s.path(
              d:
