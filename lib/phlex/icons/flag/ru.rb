      ...
      class Ru < Base
        def square
          svg(
            ...
            s.path(fill: '#0039a6', d: 'M0 170.7h512v170.6H0z')
            s.path(fill: '#d52b1e', d: 'M0 341.3h512V512H0z')
          end
        end
        ...
        def rectangle
          svg(
            ...
            s.path(fill: '#0039a6', d: 'M0 160h640v160H0z')
            s.path(fill: '#d52b1e', d: 'M0 320h640v160H0z')
          end
        end
      end
    end
