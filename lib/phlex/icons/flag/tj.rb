      ...
      class Tj < Base
        ...
        def rectangle
          svg(
            ...
            s.path(fill: %(#fff), d: %(M305.4 224.7a13.7 13.7 0 0 1 14.6 6.5 13.7 13.7 0 0 1 14.6-6.5 14.7 14.7 0 0 0-29.2 0))
            ...
            s.path(fill: %(none), stroke: %(#f8c300), stroke_width: %(11), d: %(M253.5 327.8a233.1 233.1 0 0 1 133 0))
