          ...
          svg(
            ...
            s.g(clip_path: 'url(#mz-a)', transform: 'scale(1.0321)') do
              ...
              s.path(
                ...
                stroke_width: '1.1',
                d:
                  'M99.6 281.9h35.8c2.9 3.2 9.3 4.5 15.4 0 11.2-6.2 32.9 0 32.9 0l4.3-4.6-10.4-34.1-3.8-4s-8-4.8-23.2-3.2c-15.2 1.6-20.5-.6-20.5-.6S116.7 237 113 239l-4.3 4.3-9 38.7z'
              )
              s.path(
                fill: 'none',
                stroke: '#000',
          ...
          svg(
            ...
            s.g(clip_path: 'url(#mz-a)', transform: 'scale(.9375)') do
              ...
              s.path(
                ...
                stroke_width: '1.1',
                d:
                  'M102.8 290.9h37c3 3.3 9.5 4.7 15.8 0 11.6-6.4 34 0 34 0l4.4-4.7-10.7-35.2-3.9-4.2s-8.3-5-24-3.3c-15.7 1.7-21.2-.5-21.2-.5s-13.7 1.6-17.6 3.6l-4.4 4.4z'
              )
              s.path(
                fill: 'none',
                stroke: '#000',
