      ...
      class Pc < Base
        def square
          svg(
            ...
            s.path(fill: %(#fff), d: %(M420.6 307.7s-26.9-12-81.3-12.2c-54.4-.2-112.2 14.8-144.1 14.4-32-.4-41.4-.4-60.5-4 0 0 28.9 9.6 59.5 12.4 30.7 2.9 101.6-11.1 137-13.4 36.2-2.2 64.4-2.2 89.4 2.8))
            s.path(fill: %(#00aec7), d: %(M208 323.4s20.5 1 59.8-3.2 67.2-10 98.2-10.8c31-.8 65.3 4.6 72.5 6.5 0 0-51.7-1.4-73.4 1.7-21.7 3-77.8 10.1-107.4 10.8-29.6.7-39.7-3.3-49.7-5m-85.9-29.6s54.4 14.5 103.8 5c55.7-10.9 88.5-10.7 113.4-10.8 25-.1 51 6.2 51 6.2S288 187.3 180.9 130.7c0 0-8 90.1-58.7 163))
        ...
        def rectangle
          svg(
            ...
            s.path(fill: %(#fff), d: %(M474.3 288.5S449 277.2 398 277c-51-.2-105.2 13.9-135.1 13.5-30-.3-38.8-.3-56.7-3.7 0 0 27 9 55.8 11.6 28.7 2.7 95.2-10.4 128.4-12.5 34-2.1 60.4-2.1 83.8 2.6))
            s.path(fill: %(#00aec7), d: %(M275 303.2s19.2 1 56-3c37-4 63-9.4 92.1-10.2 29.1-.7 61.2 4.4 68 6.1 0 0-48.5-1.3-68.8 1.6-20.3 3-73 9.5-100.7 10.2-27.7.6-37.3-3.2-46.6-4.7m-80.5-27.8s51 13.6 97.2 4.7c52.3-10.2 83-10 106.4-10 23.4-.2 47.9 5.7 47.9 5.7s-96-100.2-196.5-153.3c0 0-7.5 84.5-55 152.9))
