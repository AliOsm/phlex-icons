...
module PhlexIcons
  module Remix
    class CreativeCommonsByLine < Base
      def view_template
        svg(
          **attrs,
          viewbox: '0 0 24 24',
