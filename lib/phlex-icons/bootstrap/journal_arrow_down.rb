        ...
        svg(
          **attrs,
          ...
          s.path(
            fill_rule: 'evenodd',
            d:
              'M8 5a.5.5 0 0 1 .5.5v3.793l1.146-1.147a.5.5 0 0 1 .708.708l-2 2a.5.5 0 0 1-.708 0l-2-2a.5.5 0 1 1 .708-.708L7.5 9.293V5.5A.5.5 0 0 1 8 5'
          )
          s.path(
            d:
