...
module PhlexIcons
  module Bootstrap
    class SignTurnSlightRight < Base
      def view_template
        svg(
          **attrs,
          ...
          s.path(
            d:
              'm8.335 6.982.8 1.386a.25.25 0 0 0 .451-.039l1.06-2.882a.25.25 0 0 0-.192-.333l-3.026-.523a.25.25 0 0 0-.26.371l.667 1.154-.621.373A2.5 2.5 0 0 0 6 8.632V11h1V8.632a1.5 1.5 0 0 1 .728-1.286z'
          )
          s.path(
            fill_rule: 'evenodd',
            d:
