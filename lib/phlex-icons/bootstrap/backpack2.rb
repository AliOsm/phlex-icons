      ...
      def view_template
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M4.04 7.43a4 4 0 0 1 7.92 0 .5.5 0 1 1-.99.14 3 3 0 0 0-5.94 0 .5.5 0 1 1-.99-.14'
          )
          s.path(
            fill_rule: 'evenodd',
            d:
