...
module PhlexIcons
  module Huge
    class SunCloudHailstone02 < Base
      def stroke
        svg(
          **attrs,
          viewbox: '0 0 24 24',
          ...
          s.path(
            d:
              'M12.0017 15L12.0062 15.0078M15.0005 17.9967L15.005 18.0044M9.00278 17.9967L9.00727 18.0044M17.9994 20.9933L18.0039 21.0011M6.00391 20.9933L6.0084 21.0011M12.0017 21.9922L12.0062 22',
            stroke: 'currentColor',
            stroke_width: '2',
            stroke_linecap: 'round',
            stroke_linejoin: 'round'
