      ...
      def stroke
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M20 7C20 9.76142 17.7614 12 15 12C12.2386 12 10 9.76142 10 7C10 4.23858 12.2386 2 15 2C17.7614 2 20 4.23858 20 7Z',
            stroke: '#141B34',
            stroke_width: '1.5'
          )
          s.path(
