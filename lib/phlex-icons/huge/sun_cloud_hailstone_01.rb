...
module PhlexIcons
  module Huge
    class SunCloudHailstone01 < Base
      def stroke
        svg(
          **attrs,
          viewbox: '0 0 24 24',
          ...
          s.path(
            d:
              'M11.9978 15L12.0022 15.0078M14.9966 17.9967L15.0011 18.0044M8.99888 17.9967L9.00337 18.0044M17.9955 20.9933L18 21.0011M6 20.9933L6.00449 21.0011M11.9978 21.9922L12.0022 22',
            stroke: '#141B34',
            stroke_width: '2',
            stroke_linecap: 'round',
            stroke_linejoin: 'round'
