...
module PhlexIcons
  module Huge
    class PathfinderIntersect < Base
      def stroke
        svg(
          **attrs,
          viewbox: '0 0 24 24',
