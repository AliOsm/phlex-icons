      ...
      def stroke
        svg(
          **attrs,
          ...
          s.path(
            d: 'M4 16V19M4 22V19M7.5 16V19M7.5 22V19M7.5 19H4',
            stroke: 'currentColor',
            stroke_width: '1.5',
          ...
          s.path(
            d:
              'M10 22V16H11.5C12.6046 16 13.5 16.8954 13.5 18V20C13.5 21.1046 12.6046 22 11.5 22H10Z',
            stroke: 'currentColor',
            stroke_width: '1.5',
            stroke_linecap: 'round',
            stroke_linejoin: 'round'
          ...
          s.path(
            d:
              'M16 19.5V16H18.25C19.2165 16 20 16.7835 20 17.75C20 18.7165 19.2165 19.5 18.25 19.5M16 19.5V22M16 19.5H18.25M18.25 19.5L20 22',
            stroke: 'currentColor',
            stroke_width: '1.5',
            stroke_linecap: 'round',
            stroke_linejoin: 'round'
