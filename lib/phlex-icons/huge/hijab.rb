      ...
      def stroke
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M12.5 5C10.8431 5 9.5 6.34315 9.5 8V10C9.5 11.6569 10.8431 13 12.5 13C14.1569 13 15.5 11.6569 15.5 10V8C15.5 6.34315 14.1569 5 12.5 5Z',
            stroke: '#141B34',
            stroke_width: '1.5'
          )
          s.path(
            d:
              'M15.5 10C15.5 12.5 15.18 14.4 11.7667 16C8.35333 17.6 7.5 19.8333 7.5 21',
            stroke: '#141B34',
            stroke_width: '1.5'
          )
          s.path(
