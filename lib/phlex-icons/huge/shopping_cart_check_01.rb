...
module PhlexIcons
  module Huge
    class ShoppingCartCheck01 < Base
      def stroke
        svg(
          **attrs,
          viewbox: '0 0 24 24',
          ...
          s.path(
            d:
              'M8 16H15.2632C19.7508 16 20.4333 13.1808 21.261 9.06908C21.4998 7.88311 21.6192 7.29013 21.3321 6.89507C21.045 6.5 20.4947 6.5 19.3941 6.5H19M6 6.5H7.5',
            stroke: '#141B34',
            stroke_width: '1.5',
