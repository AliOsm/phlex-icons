      ...
      def stroke
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M18 17V14H19.5C20.3284 14 21 14.6716 21 15.5C21 16.3284 20.3284 17 19.5 17M18 17V19M18 17H19.5M19.5 17L21 19',
            stroke: 'currentColor',
            stroke_width: '1.5',
            stroke_linecap: 'round',
            stroke_linejoin: 'round'
          ...
          s.path(
            d:
              'M12.5 19V14H13.5C14.6046 14 15.5 14.8954 15.5 16V17C15.5 18.1046 14.6046 19 13.5 19H12.5Z',
            stroke: 'currentColor',
            stroke_width: '1.5',
            stroke_linecap: 'round',
            stroke_linejoin: 'round'
          ...
          s.path(
            d: 'M7 14V16.5M7 19V16.5M7 16.5H10M10 16.5V19M10 16.5V14',
            stroke: 'currentColor',
            stroke_width: '1.5',
            stroke_linecap: 'round',
            stroke_linejoin: 'round'
