      ...
      def stroke
        svg(
          **attrs,
          ...
          s.path(d: 'M9 21.5L9 2.5', stroke: 'currentColor', stroke_width: '1.5')
          s.path(d: 'M21.5 8L9 8', stroke: 'currentColor', stroke_width: '1.5')
          s.path(d: 'M21.5 16L9 16', stroke: 'currentColor', stroke_width: '1.5')
        end
      end
    end
  end
