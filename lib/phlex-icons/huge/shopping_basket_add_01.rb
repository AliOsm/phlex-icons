...
module PhlexIcons
  module Huge
    class ShoppingBasketAdd01 < Base
      def stroke
        svg(
          **attrs,
          viewbox: '0 0 24 24',
