      ...
      def stroke
        svg(
          **attrs,
          ...
          s.path(d: 'M12 8V11', stroke: '#141B34', stroke_width: '1.5')
          s.path(d: 'M13 13L16 15', stroke: '#141B34', stroke_width: '1.5')
          s.path(d: 'M11 13L8 15', stroke: '#141B34', stroke_width: '1.5')
          s.path(
            d:
