      ...
      def stroke
        svg(
          **attrs,
          ...
          s.path(d: 'M4.5 17.5H19.5', stroke: 'currentColor', stroke_width: '1.5')
        end
      end
    end
  end
