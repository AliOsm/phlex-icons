...
module PhlexIcons
  module Huge
    class CursorRemoveSelection01 < Base
      def stroke
        svg(
          **attrs,
          viewbox: '0 0 24 24',
