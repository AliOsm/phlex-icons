          ...
          **attrs, xmlns: 'http://www.w3.org/2000/svg', viewbox: '0 0 512 512'
          ...
          s.g(fill_rule: 'evenodd') do
            s.path(
              ...
              stroke_width: '1pt',
              d:
                'm541.5 1173.3-1.7-229.1-61.1-107c-15.3-52.6-7.8-78 17-79.8 24.7-1.6 49.2 13.6 84.8 15.3s28.9-59.4 81.5-57.7 144.3 32.3 222.3 37.4c78.1 5 118.8-27.2 208.8-30.6s113.7 42.4 118.8 42.4 30.6-18.6 56-22c25.5-3.4 34 10.2 34 10.2s-1.7 57.7-13.6 91.6c-11.9 34-54.3 90-56 90s-15.3 249.5-15.3 251.2-675.5-6.8-675.5-11.9z',
            ...
            s.path(
              ...
              stroke_width: '1pt',
              d:
                'M1275.6 655.5c-35.4-17.7-166-35.4-376.3-35.4s-350 17.7-385.5 35.4c-35.4 17.7-35.4 53.2 0 70.9s175.3 35.4 385.5 35.4 340.9-17.7 376.3-35.4 35.4-53.2 0-70.9z',
            ...
            s.path(
              fill: '#c00',
              d:
                'M346 368.9q-.1 2.1-2 2.3c-1.9.2-2.1-1-2.1-2.3q.2-2.1 2-2.3c1.2 0 2.2 1 2.2 2.3zm79.8 0c0 1.3-1 2.3-2.2 2.3q-1.8-.2-2-2.3.2-2.1 2-2.3 2 .2 2.1 2.3z'
            )
            s.path(
              d:
                'M388 367.8c0 1.2-1.9 2.2-4.2 2.2-2.2 0-4.2-1-4.2-2.3s2-2.3 4.2-2.3 4.2 1 4.2 2.3z'
            )
            s.path(
              fill: '#006300',
              d:
                'M408.1 367.8c0 1.2-1.4 2.2-3.1 2.2s-3.1-1-3.1-2.3 1.4-2.3 3-2.3 3.2 1 3.2 2.3zm-43.1 0c0 1.2-1.4 2.2-3.2 2.2s-3.2-1-3.2-2.3 1.4-2.3 3.2-2.3 3.2 1 3.2 2.3z'
            )
            s.path(
              fill: '#fff100',
              stroke: '#000',
          ...
          **attrs, xmlns: 'http://www.w3.org/2000/svg', viewbox: '0 0 640 480'
          ...
          s.g(fill_rule: 'evenodd') do
            ...
            s.path(
              fill: '#c00',
              d:
                'M440.8 350c0 1.4-1 2.6-2.3 2.6s-2.3-1.2-2.3-2.6 1-2.5 2.3-2.5 2.3 1.2 2.3 2.5m87 0c0 1.4-1 2.6-2.3 2.6s-2.3-1.2-2.3-2.6 1-2.5 2.3-2.5 2.3 1.2 2.3 2.5'
            )
            s.path(
              d:
                'M486.6 348.8c0 1.3-2.1 2.4-4.6 2.4s-4.6-1.1-4.6-2.5 2-2.5 4.6-2.5 4.6 1.2 4.6 2.5z'
            )
            s.path(
              fill: '#006300',
              d:
