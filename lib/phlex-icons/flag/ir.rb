          ...
          **attrs, xmlns: 'http://www.w3.org/2000/svg', viewbox: '0 0 512 512'
          ...
          s.g(
            ...
            s.g(fill: '#da0000') do
              s.path(
                d:
                  'M457 191.4c8.3 10 33.5 65.5-15.2 101.9-22.9 17.2-8.7 18-8 21 36.8-19.6 48.8-46 48.5-69.8s-12.8-44.6-25.2-53.1z'
              )
              s.path(
                d:
              ...
              s.path(
                d:
                  'M411 191.4c-8.2 10-33.5 65.5 15.2 101.9 22.9 17.2 8.7 18 8 21-36.7-19.6-48.8-46-48.5-69.8s12.9-44.6 25.3-53.1'
              )
              s.path(
                d:
