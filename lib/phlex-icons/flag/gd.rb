      ...
      def square
        svg(
          **attrs, xmlns: %(http://www.w3.org/2000/svg), viewbox: %(0 0 512 512), 'xmlns:xlink': %(http://www.w3.org/1999/xlink)
          ...
          s.path(fill: %(#fcd116), d: %(M86.8 207.6c11.1 23.3-29 78.7 37.8 91.7a68 68 0 0 1-11.5-44.7 76 76 0 0 1 34.6 32.8c17.5-63.4-44.8-59.5-61-79.8z))
      ...
      def rectangle
        svg(
          **attrs, xmlns: %(http://www.w3.org/2000/svg), viewbox: %(0 0 640 480), 'xmlns:xlink': %(http://www.w3.org/1999/xlink)
          ...
          s.use('xlink:href': %(#gd-d), width: %(100%), height: %(100%), x: %(100), transform: %(translate(30.3)))
          s.path(fill: %(#ce1126), d: %(M102.3 240.7a80 80 0 0 0 33.5 33.2 111 111 0 0 0-11.3-45z))
          s.path(fill: %(#fcd116), d: %(M90.1 194.7c10.4 21.7-27.1 73.7 35.5 85.9a63 63 0 0 1-10.9-41.9 70 70 0 0 1 32.5 30.8c16.4-59.5-42-55.8-57.1-74.8))
