          ...
          **attrs, xmlns: 'http://www.w3.org/2000/svg', viewbox: '0 0 512 512'
          ...
          s.g(
            ...
            s.path(
              ...
              stroke_width: '1.6',
              d:
                'M329.7 109.5c7.4-3.8 11-2.2 17.4-2.5 4.4 8 8.5 8.7 18.1 9.7a48 48 0 0 0 38.3 20.9c28.7-.8 37.8-20.9 57.1-23.1H481c-3.4-5.8-6-9.1-13.4-9.4a195 195 0 0 0-52 3.4l-24 6c-7-3.4-24.3-21.5-35.3-21.1-6.5 1.7-6.5 4-9.7 6.4-6.2 2.7-12.4 1.4-17 9.7z'
            )
            s.path(
              fill: '#ffc84b',
              fill_rule: 'evenodd',
          ...
          **attrs, xmlns: 'http://www.w3.org/2000/svg', viewbox: '0 0 640 480'
          ...
          s.g(clip_path: 'url(#ki-a)', transform: 'translate(81)scale(.9375)') do
            ...
            s.path(
              ...
              stroke_width: '1.7',
              d:
                'M174.8 108c7.7-3.9 11.5-2.3 18.2-2.5 4.5 8.3 8.8 9 18.8 10a50 50 0 0 0 39.9 21.8c29.9-.8 39.4-21.7 59.5-24h21.2c-3.5-6-6.3-9.5-14-9.9-15.8-.8-36.2-.4-54 3.6l-25.1 6.3c-7.4-3.6-25.3-22.4-36.8-22-6.7 1.8-6.7 4.1-10 6.7-6.5 2.8-13 1.4-17.7 10z'
            )
            s.path(
              fill: '#ffc84b',
              fill_rule: 'evenodd',
