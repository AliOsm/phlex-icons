      ...
      def rectangle
        svg(
          **attrs, xmlns: %(http://www.w3.org/2000/svg), viewbox: %(0 0 640 480), 'xmlns:xlink': %(http://www.w3.org/1999/xlink)
          ...
          s.g(transform: %(translate(-217.5 -9.4)scale(.77497))) do
            s.path(fill: %(#fff), d: %(m776.3 144 250.4-.9-.5 223s8.8 34-105 85.5c40.9-4.2 85.5-47.8 85.5-47.8s18.1-23.3 27-10.3 17.1 19.6 23.6 24.7 11.6 19 1.9 29.2c-9.8 10.3-25.1 11.6-29.3-.9-6.5 3.3-46.4 51.6-128.2 53.9C818.5 499 773 446 773 446s-11.1 17.7-27 3.8c-15.3-18.2-3.7-29.8-3.7-29.8s13-7.4 16.8-12.5c6-7 7.9-16.3 18-16.3 12.2 1 16.8 10.7 16.8 10.7s41.8 44.1 86.9 49.7c-101.7-48.8-105.5-79-105-86.4z))
            s.path(fill: %(#006129), stroke: %(#000), stroke_width: %(1.9), d: %(m782.3 150.1 238.8-1.4v214.6c.5 28-46.5 56.3-119.9 92.5-75.7-39-119.4-62.7-119.8-93z))
            s.g(id: %(vg-b), fill: %(#ffc72c), stroke: %(#000), stroke_width: %(.9)) do
              s.path(fill: %(none), stroke: %(#ffc72c), stroke_width: %(1.9), d: %(m814.8 181.8 14-20.7 14.3 20.8))
