      ...
      def rectangle
        svg(
          **attrs, xmlns: 'http://www.w3.org/2000/svg', viewbox: '0 0 640 480'
          ...
          s.path(fill: '#db0000', d: 'M323 0h358v225.3H323z')
          s.path(fill: '#0000ab', d: 'M0 225.3h323.1V480H0z')
          s.path(
            fill: '#0000ab',
            fill_rule: 'evenodd',
            d:
              'm214.8 177.7-42-29.4-41.7 29.6 15.5-48L105 100l51.6-.4 16-48 16.3 47.9h51.6l-41.5 30 15.9 48z'
          )
          s.path(
            fill: '#d80000',
            fill_rule: 'evenodd',
