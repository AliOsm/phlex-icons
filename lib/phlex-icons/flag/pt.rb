        ...
        svg(
          **attrs, xmlns: %(http://www.w3.org/2000/svg), viewbox: %(0 0 512 512), 'xmlns:xlink': %(http://www.w3.org/1999/xlink)
          ...
          s.g(fill: %(#ff0), fill_rule: %(evenodd), stroke: %(#000), stroke_linecap: %(round), stroke_linejoin: %(round), stroke_width: %(.6)) do
            ...
            s.path(stroke_width: %(.7), d: %(M100.8 208.5c6.5-4.3 53.7 16.7 103 46.5s96.4 63.6 92.2 70l-1.4 2.1-.7.5c.2 0 .9-1 0-3.3-2.2-6.9-35.5-33.5-91-67-54-32.2-99-51.6-103.5-46zm205.3 101.2c4-8-39.7-41-94-73.1-55.5-31.5-95.6-50-102.9-44.5l-1.6 3q-.1 0 .4-.5c1.3-1.1 3.5-1 4.5-1 12.6.1 48.6 16.6 99 45.6 22.1 12.8 93.4 58.6 93.1 71.4 0 1.1.1 1.3-.3 1.9z))
          end
          s.g(transform: %(translate(-68.3 28.4)scale(1.13778))) do
            ...
            s.g(id: %(pt-e)) do
              s.g(id: %(pt-d), fill: %(#ff0), stroke: %(#000), stroke_width: %(.5)) do
                ...
                s.path(id: %(pt-b), d: %(M186.3 139h1.2v1h.9v-1h1.2v1h.9v-1h1.2v2q0 .6-.5.6h-4.3a1 1 0 0 1-.6-.6z))
        ...
        svg(
          **attrs, xmlns: %(http://www.w3.org/2000/svg), viewbox: %(0 0 640 480), 'xmlns:xlink': %(http://www.w3.org/1999/xlink)
          ...
          s.g(fill: %(#ff0), fill_rule: %(evenodd), stroke: %(#000), stroke_linecap: %(round), stroke_linejoin: %(round), stroke_width: %(.6)) do
            ...
            s.path(d: %(M158.6 195.5c6-4 50.2 15.6 96.6 43.6 46.1 28 90.3 59.6 86.3 65.5l-1.3 2.1-.6.5c.1-.1.8-1 0-3.1-2-6.5-33.4-31.5-85.3-62.9-50.7-30.1-92.9-48.3-97-43.1zM351 290.4c3.8-7.6-37.2-38.5-88.1-68.6-52-29.5-89.6-46.9-96.5-41.7L165 183q-.1 0 .4-.5c1.2-1 3.3-1 4.2-1 11.8.2 45.5 15.7 92.8 42.8 20.8 12 87.6 55 87.3 67 0 1 .1 1.2-.3 1.8l1.7-2.6z))
          end
