        ...
        svg(
          **attrs, xmlns: %(http://www.w3.org/2000/svg), viewbox: %(0 0 512 512), 'xmlns:xlink': %(http://www.w3.org/1999/xlink)
          ...
          s.g(fill: %(#ffd83d), stroke: %(#000), stroke_linecap: %(round), stroke_linejoin: %(round), stroke_width: %(2), transform: %(translate(-54)scale(.85333))) do
            ...
            s.path(fill: %(none), stroke_width: %(1.5), d: %(M219.3 89.9v6.6a63 63 0 0 0-7.4.8m20.2 0a62 62 0 0 0-7.5-.8v-6.6m-12.8 12.7a61 61 0 0 1 10.2-.9q5.2 0 10 .9))
