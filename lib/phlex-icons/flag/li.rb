      ...
      def rectangle
        svg(
          **attrs, xmlns: %(http://www.w3.org/2000/svg), viewbox: %(0 0 640 480), 'xmlns:xlink': %(http://www.w3.org/1999/xlink)
          ...
          s.path(fill: %(#002b7f), d: %(M0 0h640v240H0z))
          s.path(fill: %(#ce1126), d: %(M0 240h640v240H0z))
          s.g(fill: %(#ffd83d), stroke: %(#000), stroke_linecap: %(round), stroke_linejoin: %(round), stroke_width: %(2), transform: %(scale(.8))) do
            s.g(id: %(li-a)) do
              s.path(stroke: %(none), d: %(m216.4 122.3-1.9 62.5h-63.4c-7.8-15.2-14.2-28-14.2-45.5 0-14.6 11.5-26.2 28-26.2 17.5 0 36.8 5.9 51.5 9.2))
              s.g(stroke_width: %(1.5)) do
                s.path(d: %(M144.5 125.2v36m5-39.7v48m5.2-50.5v57.2m5-58.4v44.9m5.1-45.1v45.3m5.1-47v47m5.1-47v47m5.1-46.5v47m5.1-46.5v46.9m5.1-44v47m5-46.5v52.9m5.2-52.9v47m5-47v47))
