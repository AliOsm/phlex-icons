          ...
          **attrs, xmlns: 'http://www.w3.org/2000/svg', viewbox: '0 0 512 512'
          ...
          s.g(clip_path: 'url(#ug-a)', transform: 'translate(-128)scale(1.0321)') do
            ...
            s.path(
              ...
              stroke_width: '.8',
              d:
                'M364 208s-18.4 20.2-10.5 35.7c.5-2.2.3-3.5.5-3.4-.4-.3 2.3 1.8 2 1.4.2-1.1-.7-3.5-.7-3.5l2.4.6-1.4-2.7 3.5.5s-1.2-3.4-.8-3.4l2.9.2c-5.2-9.3-.3-17 2-25.3z'
            )
            s.path(
              fill: '#9ca69c',
              fill_rule: 'evenodd',
            ...
            s.path(
              ...
              stroke_width: '.9',
              d:
                'M401.2 273.6s-6.4-15.3-22.5-19.2-14.1-21-12.8-22.1c.7-1.5 1.2-3.8 5.9-1.6s26.1 13 29.2 13.5.4 29.8.2 29.4z'
            )
            s.path(
              fill: '#de3108',
              fill_rule: 'evenodd',
              ...
              stroke_width: '.8',
              d:
                'M385.8 254.4c-.3.1 21.6 12.9 15 23.9 6.3-4.1 4.2-11.4 4.2-11.4s5.1 13.3-7.3 19.8c1.4 1.2 2.2.9 2.2.9l-2 2.1s-1 1.6 7.3-2.4c-2.3 1.8-2.5 3.1-2.5 3.1s.7 1.8 6.1-3a30 30 0 0 0-5.4 7.2c12-1.1 37.8-39.7-8.1-51.1l2 2.2z'
            )
            s.path(
              fill: '#fff',
              fill_rule: 'evenodd',
