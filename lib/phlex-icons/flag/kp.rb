          ...
          **attrs, xmlns: 'http://www.w3.org/2000/svg', viewbox: '0 0 512 512'
          ...
          s.g(
            ...
            s.path(
              fill: '#fff',
              d:
                'M473 250.7c0 60.1-61.5 108.9-137.4 108.9S198 310.8 198 250.6c0-60.1 61.6-108.9 137.6-108.9S473 190.5 473 250.7'
            )
            s.path(
              fill: '#c40000',
              d:
          ...
          **attrs, xmlns: 'http://www.w3.org/2000/svg', viewbox: '0 0 640 480'
          ...
          s.g(
            ...
            s.path(
              fill: '#fff',
              d:
                'M328.5 256c0 63.5-53 115-118.6 115S91.3 319.5 91.3 256s53-114.8 118.6-114.8 118.6 51.4 118.6 114.9z'
            )
            s.path(
              fill: '#c40000',
              d:
