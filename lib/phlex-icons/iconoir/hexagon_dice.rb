...
module PhlexIcons
  module Iconoir
    class HexagonDice < PhlexIcons::Iconoir::Base
      def solid
      ...
      def regular
        svg(
          **attrs,
          ...
          s.path(d: 'M2.5 6.5L12 7', stroke: 'currentColor', stroke_linejoin: 'round')
          s.path(d: 'M2.5 6.5L7 15', stroke: 'currentColor', stroke_linejoin: 'round')
          s.path(d: 'M21.5 6.5L17 15', stroke: 'currentColor', stroke_linejoin: 'round')
          s.path(
          ...
          s.path(d: 'M2.5 17.5L7 15', stroke: 'currentColor', stroke_linejoin: 'round')
          s.path(
            d: 'M7 15L12 23L17 15',
            stroke: 'currentColor',
            stroke_linejoin: 'round'
