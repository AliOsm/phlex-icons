...
module PhlexIcons
  module Iconoir
    class Diameter < PhlexIcons::Iconoir::Base
      def solid
        svg(
          **attrs,
          viewbox: '0 0 24 24',
