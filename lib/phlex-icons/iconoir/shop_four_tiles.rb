...
module PhlexIcons
  module Iconoir
    class ShopFourTiles < PhlexIcons::Iconoir::Base
      def solid
      ...
      def regular
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M14.8333 21V15C14.8333 13.8954 13.9379 13 12.8333 13H10.8333C9.72874 13 8.83331 13.8954 8.83331 15V21',
            stroke: 'currentColor',
            stroke_miterlimit: '16'
          )
        end
      end
    end
