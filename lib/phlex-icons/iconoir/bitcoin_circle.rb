...
module PhlexIcons
  module Iconoir
    class BitcoinCircle < PhlexIcons::Iconoir::Base
      def solid
        svg(
          **attrs,
          viewbox: '0 0 24 24',
