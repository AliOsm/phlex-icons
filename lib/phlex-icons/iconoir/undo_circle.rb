...
module PhlexIcons
  module Iconoir
    class UndoCircle < PhlexIcons::Iconoir::Base
      def solid
        svg(
          **attrs,
          viewbox: '0 0 24 24',
