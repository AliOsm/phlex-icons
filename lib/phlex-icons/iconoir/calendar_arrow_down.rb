...
module PhlexIcons
  module Iconoir
    class CalendarArrowDown < PhlexIcons::Iconoir::Base
      def solid
        svg(
          **attrs,
          viewbox: '0 0 24 24',
          ...
          s.path(
            ...
            clip_rule: 'evenodd',
            d:
              'M18.4697 22.5303C18.7626 22.8232 19.2374 22.8232 19.5303 22.5303L22.5303 19.5303C22.8232 19.2374 22.8232 18.7626 22.5303 18.4697C22.2374 18.1768 21.7626 18.1768 21.4697 18.4697L19.75 20.1893V16C19.75 15.5858 19.4142 15.25 19 15.25C18.5858 15.25 18.25 15.5858 18.25 16V20.1893L16.5303 18.4697C16.2374 18.1768 15.7626 18.1768 15.4697 18.4697C15.1768 18.7626 15.1768 19.2374 15.4697 19.5303L18.4697 22.5303Z',
            fill: 'currentColor'
          )
        end
      end
