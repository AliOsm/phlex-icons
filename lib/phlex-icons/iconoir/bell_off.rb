...
module PhlexIcons
  module Iconoir
    class BellOff < PhlexIcons::Iconoir::Base
      def solid
      ...
      def regular
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M7.75732 3.87452C8.88254 2.67428 10.4087 2 12 2C13.5913 2 15.1174 2.67428 16.2426 3.87452C17.3678 5.07475 18 6.70261 18 8.4C18 15.8667 21 18 21 18',
            stroke: 'currentColor',
            stroke_linecap: 'round',
            stroke_linejoin: 'round'
          )
