...
module PhlexIcons
  module Iconoir
    class RoundFlask < PhlexIcons::Iconoir::Base
      def solid
        svg(
          **attrs,
          viewbox: '0 0 24 24',
          ...
          s.path(
            ...
            clip_rule: 'evenodd',
            d:
              'M13.5117 6.44156C13.8196 6.71865 13.8446 7.19287 13.5675 7.50075L13.5575 7.51186C13.2804 7.81975 12.8062 7.84471 12.4983 7.56761C12.1904 7.29052 12.1654 6.8163 12.4425 6.50842L12.4525 6.49731C12.7296 6.18942 13.2038 6.16447 13.5117 6.44156Z',
            fill: 'currentColor'
          )
          s.path(
            fill_rule: 'evenodd',
      ...
      def regular
        svg(
          **attrs,
          ...
          s.path(d: 'M19 15L5 15', stroke: 'currentColor', stroke_linejoin: 'round')
          s.path(
            d: 'M16 4L8 4',
            stroke: 'currentColor',
