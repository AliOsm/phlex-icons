...
module PhlexIcons
  module Iconoir
    class KeyframeMinus < PhlexIcons::Iconoir::Base
      def solid
        svg(
          **attrs,
          viewbox: '0 0 24 24',
          ...
          s.path(
            ...
            clip_rule: 'evenodd',
            d:
              'M15.25 5C15.25 4.58579 15.5858 4.25 16 4.25H22C22.4142 4.25 22.75 4.58579 22.75 5C22.75 5.41421 22.4142 5.75 22 5.75H16C15.5858 5.75 15.25 5.41421 15.25 5Z',
            fill: 'currentColor'
          )
          s.path(
            d:
