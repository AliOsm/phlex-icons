...
module PhlexIcons
  module Iconoir
    class BirthdayCake < PhlexIcons::Iconoir::Base
      def solid
      ...
      def regular
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M4 16.5V20C4 21.1046 4.89543 22 6 22H18C19.1046 22 20 21.1046 20 20V16.5',
            stroke: 'currentColor',
          ...
          s.path(
            d:
              'M12 8C13.2624 8 14 7.03185 14 5.375C14 3.71815 12 2 12 2C12 2 10 3.71815 10 5.375C10 7.03185 10.7376 8 12 8Z',
            stroke: 'currentColor',
            stroke_linecap: 'round',
            stroke_linejoin: 'round'
          )
