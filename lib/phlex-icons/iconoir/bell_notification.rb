...
module PhlexIcons
  module Iconoir
    class BellNotification < PhlexIcons::Iconoir::Base
      def solid
        svg(
          **attrs,
          viewbox: '0 0 24 24',
          ...
          s.path(
            ...
            clip_rule: 'evenodd',
            d:
              'M15.25 5C15.25 2.92893 16.9289 1.25 19 1.25C21.0711 1.25 22.75 2.92893 22.75 5C22.75 7.07107 21.0711 8.75 19 8.75C16.9289 8.75 15.25 7.07107 15.25 5Z',
            fill: 'currentColor'
          )
          s.path(
            fill_rule: 'evenodd',
      ...
      def regular
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M18.1336 11C18.7155 16.3755 21 18 21 18H3C3 18 6 15.8667 6 8.4C6 6.70261 6.63214 5.07475 7.75736 3.87452C8.88258 2.67428 10.4087 2 12 2C12.3373 2 12.6717 2.0303 13 2.08949',
            stroke: 'currentColor',
