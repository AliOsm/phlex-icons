...
module PhlexIcons
  module Iconoir
    class TemperatureLow < PhlexIcons::Iconoir::Base
      def solid
      ...
      def regular
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M9 14C7.89543 14 7 14.8954 7 16C7 17.1046 7.89543 18 9 18C10.1046 18 11 17.1046 11 16C11 14.8954 10.1046 14 9 14ZM9 14V11',
            stroke: 'currentColor',
            stroke_linecap: 'round',
            stroke_linejoin: 'round'
          )
