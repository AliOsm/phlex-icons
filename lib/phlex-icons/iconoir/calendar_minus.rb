...
module PhlexIcons
  module Iconoir
    class CalendarMinus < PhlexIcons::Iconoir::Base
      def solid
        svg(
          **attrs,
          viewbox: '0 0 24 24',
          ...
          s.path(
            ...
            clip_rule: 'evenodd',
            d:
              'M15.2422 19C15.2422 18.5858 15.578 18.25 15.9922 18.25H22C22.4142 18.25 22.75 18.5858 22.75 19C22.75 19.4142 22.4142 19.75 22 19.75H15.9922C15.578 19.75 15.2422 19.4142 15.2422 19Z',
            fill: 'currentColor'
          )
          s.path(
            fill_rule: 'evenodd',
