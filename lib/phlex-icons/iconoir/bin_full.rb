...
module PhlexIcons
  module Iconoir
    class BinFull < PhlexIcons::Iconoir::Base
      def solid
      ...
      def regular
        svg(
          **attrs,
          ...
          s.path(d: 'M16 2L14 7', stroke: 'currentColor', stroke_width: '1.5')
          s.path(d: 'M9 6.5L9.81818 3.5', stroke: 'currentColor', stroke_width: '1.5')
          s.path(
