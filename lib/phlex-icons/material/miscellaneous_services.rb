...
module PhlexIcons
  module Material
    class MiscellaneousServices < Base
      def filled
        svg(
          **attrs,
          fill: 'currentColor',
