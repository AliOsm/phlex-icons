      ...
      def two_tone
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M7.06 5 2.4 12l4.67 7H22V5H7.06c.01 0 .01 0 0 0zM9 8.41 10.41 7 14 10.59 17.59 7 19 8.41 15.41 12 19 15.59 17.59 17 14 13.41 10.41 17 9 15.59 12.59 12 9 8.41z',
            opacity: '.3'
          )
          s.path(
            d:
