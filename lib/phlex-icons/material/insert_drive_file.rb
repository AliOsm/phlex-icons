      ...
      def sharp
        svg(
          **attrs,
          ...
          s.path(d: 'M4.01 2 4 22h16V8l-6-6H4.01zM13 9V3.5L18.5 9H13z')
        end
      end
      ...
      def two_tone
        svg(
          **attrs,
          ...
          s.path(d: 'M13 4H6v16h12V9h-5z', opacity: '.3')
          s.path(
            d:
              'm20 8-6-6H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8zm-2 12H6V4h7v5h5v11z'
          )
        end
      end
    end
