      ...
      def two_tone
        svg(
          **attrs,
          ...
          s.path(
            d:
              'm19.21 12.04-1.53-.11-.3-1.5A5.484 5.484 0 0 0 12 6C9.94 6 8.08 7.14 7.12 8.96l-.5.95-1.07.11A3.99 3.99 0 0 0 2 14c0 2.21 1.79 4 4 4h13c1.65 0 3-1.35 3-3 0-1.55-1.22-2.86-2.79-2.96z',
            opacity: '.3'
          )
          s.path(
            d:
