      ...
      def filled
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M8 19h3v3h2v-3h3l-4-4-4 4zm8-15h-3V1h-2v3H8l4 4 4-4zM4 9v2h16V9H4zm0 3h16v2H4z'
          )
        end
      end
      ...
      def outlined
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M4 9v2h16V9H4zm12-5-1.41-1.41L13 4.17V1h-2v3.19L9.39 2.61 8 4l4 4 4-4zM4 14h16v-2H4v2zm4 5 1.39 1.39L11 18.81V22h2v-3.17l1.59 1.59L16 19l-4-4-4 4z'
          )
        end
      end
