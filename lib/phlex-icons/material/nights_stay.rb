      ...
      def round
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M11.1 12.08c-2-3.88-.92-7.36.07-9.27.19-.36-.12-.77-.53-.72-5.02.68-8.86 5.07-8.65 10.32.01 0 .01 0 .01.01.62-.27 1.29-.42 2-.42 1.66 0 3.18.83 4.1 2.15A4.01 4.01 0 0 1 11 18c0 1.52-.87 2.83-2.12 3.51.98.32 2.03.5 3.11.5a10 10 0 0 0 7.76-3.69c.26-.32.04-.79-.37-.82-2.49-.13-6.28-1.53-8.28-5.42z'
          )
          s.path(
            d:
              'M7 16h-.18C6.4 14.84 5.3 14 4 14c-1.66 0-3 1.34-3 3s1.34 3 3 3h3c1.1 0 2-.9 2-2s-.9-2-2-2z'
      ...
      def two_tone
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M8.1 14.15A4.01 4.01 0 0 1 11 18c0 .68-.19 1.31-.48 1.87a8 8 0 0 0 5.61-1.01c-2.62-.92-5.23-2.82-6.8-5.86-1.59-3.06-1.55-5.91-1.04-8.1a7.966 7.966 0 0 0-4.3 7.1h.02c1.65 0 3.17.83 4.09 2.15z',
            opacity: '.3'
          )
          s.path(
            d:
