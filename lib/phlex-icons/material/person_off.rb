      ...
      def round
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M8.65 5.82a3.999 3.999 0 1 1 5.53 5.53L8.65 5.82zM20 17.17c-.02-1.1-.63-2.11-1.61-2.62-.54-.28-1.13-.54-1.77-.76L20 17.17zm.49 3.32L3.51 3.51A.996.996 0 1 0 2.1 4.92l8.18 8.18c-1.82.23-3.41.8-4.7 1.46C4.6 15.08 4 16.11 4 17.22V20h13.17l1.9 1.9c.39.39 1.02.39 1.41 0 .4-.39.4-1.02.01-1.41z'
          )
        end
      end
      ...
      def two_tone
        svg(
          **attrs,
          ...
          s.path(
            d:
              'm15.17 18-3-3H12c-2.37 0-4.29.73-5.48 1.34-.32.16-.52.5-.52.88V18h9.17zM10.13 7.3A1.99 1.99 0 0 1 12 6c1.1 0 2 .9 2 2 0 .86-.54 1.59-1.3 1.87',
            opacity: '.3'
          )
          s.path(
            d:
