      ...
      def filled
        svg(
          **attrs,
          ...
          s.path(d: 'M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z')
        end
      end
      ...
      def sharp
        svg(
          **attrs,
          ...
          s.path(d: 'M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8h5z')
        end
      end
      ...
      def two_tone
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M12 3 2 12h3v8h6v-6h2v6h6v-8h3L12 3zm5 15h-2v-6H9v6H7v-7.81l5-4.5 5 4.5V18z'
          )
          s.path(d: 'M7 10.19V18h2v-6h6v6h2v-7.81l-5-4.5z', opacity: '.3')
        end
      end
    end
  end
