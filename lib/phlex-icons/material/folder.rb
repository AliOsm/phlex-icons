      ...
      def outlined
        svg(
          **attrs,
          ...
          s.path(
            d:
              'm9.17 6 2 2H20v10H4V6h5.17M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z'
          )
        end
      end
      ...
      def sharp
        svg(
          **attrs,
          ...
          s.path(d: 'M10 4H2v16h20V6H12l-2-2z')
        end
      end
      ...
      def two_tone
        svg(
          **attrs,
          ...
          s.path(d: 'm11.17 8-.58-.59L9.17 6H4v12h16V8h-8z', opacity: '.3')
          s.path(
            d:
