      ...
      def two_tone
        svg(
          **attrs,
          ...
          s.path(
            d:
              'm4 17.17.59-.59.58-.58H20V4H4v13.17zM18 14h-7.5l2-2H18v2zM6 11.53l5.88-5.88c.2-.2.51-.2.71 0l1.77 1.77c.2.2.2.51 0 .71L8.47 14H6v-2.47z',
            opacity: '.3'
          )
          s.path(
            d:
