      ...
      def sharp
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M19 1H5v22h14V1zm-2 14.21c-1.5-.77-3.2-1.21-5-1.21s-3.5.44-5 1.21V6h10v9.21z'
          )
          s.circle(cx: '12', cy: '10', r: '3')
        end
      end
      ...
      def two_tone
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M7 20h10v1H7zm0-2.48V18h10v-.48c-1.47-.99-3.22-1.52-5-1.52s-3.53.53-5 1.52z',
            opacity: '.3'
          )
          s.circle(cx: '12', cy: '10', r: '1', opacity: '.3')
          s.path(d: 'M7 3h10v1H7z', opacity: '.3')
          s.path(
            d:
              'M17 1H7c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-2-2-2zm0 20H7v-1h10v1zm0-3H7v-.48c1.47-.99 3.22-1.52 5-1.52s3.53.53 5 1.52V18zm0-2.79c-1.5-.77-3.2-1.21-5-1.21s-3.5.44-5 1.21V6h10v9.21zM17 4H7V3h10v1z'
          )
