      ...
      def sharp
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M18 3h-4V2h-4v1H3v8h4.23l.64 4.13L6 17v5h12v-5l-1.87-1.87L18 3zM5 9V5h1.31l.62 4H5zm7 10c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm2.29-5H9.72L8.33 5h7.34l-1.38 9z'
          )
        end
      end
      ...
      def two_tone
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M13 16h-2c-1.65 0-3 1.35-3 3v1h8v-1c0-1.65-1.35-3-3-3zm-1 3c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1z',
            opacity: '.3'
          )
          s.path(
            d:
