      ...
      def outlined
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M14 11.5h2.5c.55 0 1-.45 1-1v-4c0-.55-.45-1-1-1H14c-.55 0-1 .45-1 1v4c0 .55.45 1 1 1zm.5-4.5H16v3h-1.5V7zM11 10H8V9h2c.55 0 1-.45 1-1V6.5c0-.55-.45-1-1-1H6.5V7h3v1h-2c-.55 0-1 .45-1 1v2.5H11V10z'
          )
        end
      end
      ...
      def round
        svg(
          **attrs,
          ...
          s.path(d: 'M15 14h1.5v1.5H15zm-.5-7H16v3h-1.5z')
        end
      end
      ...
      def sharp
        svg(
          **attrs,
          ...
          s.path(d: 'M14.5 7H16v3h-1.5z')
          s.path(
            d:
              'M3 3v18h18V3H3zm3.5 5h3V7h-3V5.5H11V9H8v1h3v1.5H6.5V8zm6 10.5H11V14h-1v3H8.5v-3h-1v4.5H6v-6h6.5v6zm.5-13h4.5v6H13v-6zM18 17h-3v1.5h-1.5v-6H18V17z'
          )
