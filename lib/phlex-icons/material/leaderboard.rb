      ...
      def filled
        svg(
          **attrs,
          ...
          s.path(d: 'M7.5 21H2V9h5.5v12zm7.25-18h-5.5v18h5.5V3zM22 11h-5.5v10H22V11z')
        end
      end
      ...
      def outlined
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M16 11V3H8v6H2v12h20V11h-6zm-6-6h4v14h-4V5zm-6 6h4v8H4v-8zm16 8h-4v-6h4v6z'
          )
        end
      end
      ...
      def two_tone
        svg(
          **attrs,
          ...
          s.path(d: 'M10 5h4v14h-4V5zm-6 6h4v8H4v-8zm16 8h-4v-6h4v6z', opacity: '.3')
          s.path(
            d:
              'M16 11V3H8v6H2v12h20V11h-6zm-6-6h4v14h-4V5zm-6 6h4v8H4v-8zm16 8h-4v-6h4v6z'
          )
