      ...
      def outlined
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M18 2h-8L4.02 8 4 20c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 18H6V8.83L10.83 4H18v16zm-7-5h2v2h-2zm0-7h2v5h-2z'
          )
        end
      end
      ...
      def sharp
        svg(
          **attrs,
          ...
          s.path(d: 'M20 2H10L4 8v14h16V2zm-7 15h-2v-2h2v2zm0-4h-2V8h2v5z')
        end
      end
