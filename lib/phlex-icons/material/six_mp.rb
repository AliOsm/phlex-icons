      ...
      def outlined
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M11 11.5h2.5c.55 0 1-.45 1-1V9c0-.55-.45-1-1-1h-2V7h3V5.5H11c-.55 0-1 .45-1 1v4c0 .55.45 1 1 1zm.5-2.5H13v1.5h-1.5V9z'
          )
        end
      end
      ...
      def sharp
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M3 3v18h18V3H3zm7 2.5h4.5V7h-3v1h3v3.5H10v-6zm2.5 13H11V14h-1v3H8.5v-3h-1v4.5H6v-6h6.5v6zM18 17h-3v1.5h-1.5v-6H18V17z'
          )
          s.path(d: 'M11.5 9H13v1.5h-1.5z')
        end
      end
      ...
      def two_tone
        svg(
          **attrs,
          ...
          s.path(d: 'M15 14h1.5v1.5H15zm-3.5-5H13v1.5h-1.5z', opacity: '.3')
          s.path(
            d:
              'M5 19h14V5H5v14zm13-5.5V16c0 .55-.45 1-1 1h-2v1.5h-1.5v-6H17c.55 0 1 .45 1 1zm-8-7c0-.55.45-1 1-1h3.5V7h-3v1h2c.55 0 1 .45 1 1v1.5c0 .55-.45 1-1 1H11c-.55 0-1-.45-1-1v-4zm-4 7c0-.55.45-1 1-1h4.5c.55 0 1 .45 1 1v5H11V14h-1v3H8.5v-3h-1v4.5H6v-5z',
            opacity: '.3'
          )
          s.path(
            d:
