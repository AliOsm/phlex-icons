      ...
      def sharp
        svg(
          **attrs,
          ...
          s.path(d: 'M6 21h12V7H6v14zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z')
        end
      end
      ...
      def two_tone
        svg(
          **attrs,
          ...
          s.path(d: 'M8 9h8v10H8z', opacity: '.3')
          s.path(
            d:
              'm15.5 4-1-1h-5l-1 1H5v2h14V4zM6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM8 9h8v10H8V9z'
          )
        end
      end
    end
