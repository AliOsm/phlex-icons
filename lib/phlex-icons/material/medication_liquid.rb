...
**attrs,
fill: 'currentColor',
xmlns: "http://www.w3.org/2000/svg", viewbox: "0 0 24 24") do |s|
  s.path(
    d:
...
**attrs,
fill: 'currentColor',
xmlns: %(http://www.w3.org/2000/svg), viewbox: %(0 0 24 24), xmlns:xlink: %(http://www.w3.org/1999/xlink)) { |s|s.g(opacity: %(.3)) {s.defs {s.path(id: %(a), d: %(M4 8h10v11H4z), opacity: %(.3))
 }
s.use(xlink:href: %(#a), overflow: %(visible))
s.clipPath(id: %(b)) {s.use(xlink:href: %(#a), overflow: %(visible))
 }
