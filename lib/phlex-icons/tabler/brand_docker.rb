      ...
      def outline
        svg(
          **attrs,
          ...
          s.path(d: 'M5 10h3v3h-3l0 -3')
          s.path(d: 'M8 10h3v3h-3l0 -3')
          s.path(d: 'M11 10h3v3h-3l0 -3')
          s.path(d: 'M8 7h3v3h-3l0 -3')
          s.path(d: 'M11 7h3v3h-3l0 -3')
          s.path(d: 'M11 4h3v3h-3l0 -3')
