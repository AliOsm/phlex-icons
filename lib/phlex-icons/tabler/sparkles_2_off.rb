      ...
      def outline
        svg(
          **attrs,
          ...
          s.path(
            d:
              'M14.756 14.77c-2.16 .93 -3.34 2.207 -4.224 4.568a20 20 0 0 0 -.532 1.662a20 20 0 0 0 -.532 -1.662c-.963 -2.568 -2.275 -3.853 -4.816 -4.806a21 21 0 0 0 -1.652 -.532a21 21 0 0 0 1.652 -.532c2.345 -.879 3.642 -2.04 4.585 -4.23'
          )
          s.path(d: 'M3 3l18 18')
        end
      end
